...
File: model/model_MobileConv.py
 - Contain model with Mobile-conv class.
...
from .simplenet_MobileConv import MobileConv


class MobileConvModel(nn.Module):
    """
    Description: MobileModel class.
    """
    ...
    def __init__(self, num_classes=10, alpha=1, which='VGG16'):
        """
        Initialize Mobile-conv Model as argument configurations.
        ...
        super(MobileConvModel, self).__init__()

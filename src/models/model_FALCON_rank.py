...
File: model/model_FALCON_rank.py
 - Contain model with rank FALCON class.
...
from .simplenet_FALCON_rank import FALCONRank


class RankFALCONModel(nn.Module):
    """
    Description: Model with Rank FALCON class.
    """
    ...
    def __init__(self, rank=2, num_classes=10, alpha=1, which='VGG16'):
        """
        ...
        super(RankFALCONModel, self).__init__()
